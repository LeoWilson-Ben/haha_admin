...
export const api = {
  ...
  getAnnouncements: (params) => client.get('/announcements', { params }).then(r => r.data),
  getAnnouncement: (id) => client.get(`/announcements/${id}`).then(r => r.data),
  createAnnouncement: (body) => client.post('/announcements/create', body).then(r => r.data),
  updateAnnouncement: (id, body) => client.put(`/announcements/${id}/update`, body).then(r => r.data),
  setAnnouncementStatus: (id, status) => client.post(`/announcements/${id}/status`, { status }).then(r => r.data),
  deleteAnnouncement: (id) => client.post(`/announcements/${id}/delete`).then(r => r.data),
